...
export { getBootValue, getOptions, initComponentDefault, bootstrapSize, bootstrapButtonVariant, bootstrapIcon, bootstrapCardVariant, bootstrapCardImg, size, direction, variant, position_button, type_button, type_input, position_img, position_icon, align_card } from '../utils/bootstrap';
export { capitalize, generateId, validator, isObject } from '../utils/functions';
